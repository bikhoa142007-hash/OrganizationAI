...
- [x] React main flows use API; loading/errors/conflicts/history tested.
- [x] Browser E2E auto approval and Human Review persist.
- [x] Final pytest/frontend build/tests and integration reports complete.
